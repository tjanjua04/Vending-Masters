...
class InventoryModel(db.Model):
    ...
    operation = db.Column("operation", db.Boolean)
    items = db.relationship("ItemModel", back_populates="inventory")
    transactions_list = db.relationship(
        "TransactionsListModel", back_populates="inventory")
...
class TransactionsListModel(db.Model):
    ...
    transactions_list_id = db.Column(db.Integer, db.ForeignKey(
        "inventory.inventory_id"), primary_key=True)
    inventory = db.relationship(
        "InventoryModel", back_populates="transactions_list")
    transaction = db.relationship(
        "TransactionModel", back_populates="transactions_list")
...
class TransactionModel(db.Model):
    ...
    transactions_list = db.relationship(
        "TransactionsListModel", back_populates="transaction")
    transactions_list_id = db.Column(db.Integer, db.ForeignKey(
        "transactions_list.transactions_list_id"))
